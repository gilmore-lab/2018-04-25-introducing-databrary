...
### [Access agreement](https://www.databrary.org/resources/agreement.html) signed by researcher, institution

---

```{r databrary-stats, include=FALSE}
library(databraryapi)
db_stats_now <- databraryapi::get_db_stats()
```

###  `r db_stats_now['institutions']` Institutions • `r db_stats_now['investigators']` Investigators

<img src="img/databrary-institutions.jpg" width=800px/>

## **Seek permission to share**: Using [standardized template language](https://www.databrary.org/resources/templates/release-template.html)
...
<img src="http://cas.la.psu.edu/images/sticker.jpg/@@images/2e843ca5-9446-49a7-802b-b145d4004d75.jpeg" width=700px/>
...
### Visualize [Datavyu timelines](https://github.com/PLAY-behaviorome/video-coding) stored on Databrary
